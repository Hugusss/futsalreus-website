  ...
  return (
    <section id="partits" className="py-16 md:py-24 bg-secondary">
      <div className="container mx-auto px-4">
        ...
        <Card className="max-w-2xl mx-auto border-none shadow-elevated overflow-hidden">
          ...
          <CardContent className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              {/* Away Team */}
              <div className="text-center flex-1">
                <div className="w-20 h-20 mx-auto bg-muted rounded-full flex items-center justify-center mb-3">
